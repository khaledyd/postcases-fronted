        ...
        <div className=' w-full h-screen  bg-brandv4 flex justify-center items-center'>
            <div className=' w-max h-max bg-brand-secondary  border border-branv2 border-opacity-10 rounded-md'>
                ...
                <div className=' w-full h-max   p-10 sm:p-15   md:px-24  md:py-16 flex flex-col '>
                    ...
                    <div className=' gap-3  w-full flex justify-between  items-center'>                    <p className=' text-sm font-openSans text-brand-base/50  mt-3'>Laready  have an account  ?</p>
                        <p className=' text-sm underline font-openSans   text-brand-primary  mt-3'>Sign In</p></div>
                </div>
            </div>
