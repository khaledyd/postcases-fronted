...
export default function Signin() {
    return (
        <div className=' w-full h-screen  bg-brandv4 flex justify-center items-center'>
            <div className=' w-max h-max bg-brand-secondary  border border-branv2 border-opacity-10 rounded-md'>
                ...
                <div className=' w-full h-max   p-10 sm:p-15  md:p-24 flex flex-col '>
                    <button className=' px-3 py-2 rounded-md bg-brandv3  text-sm text-brand-base  font-poppins'><GoogleIcon sx={{
                        marginRight: "5px",
                        fontSize: "20px"
                    ...
                    <div className=' gap-3  w-full flex justify-between  items-center'>                    <p className=' text-sm font-openSans text-brand-base/50  mt-3'>Do not have an account yet ?</p>
                        <p className=' text-sm underline font-openSans   text-brand-primary  mt-3'>Sign up</p></div>
                </div>
            </div>
